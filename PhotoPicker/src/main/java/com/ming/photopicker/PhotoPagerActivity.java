...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> thumbnails = getIntent().getStringArrayListExtra(PhotoPreview.EXTRA_THUMBNAILS);
        if (pagerFragment == null) {
            pagerFragment =
                    (ImagePagerFragment) getSupportFragmentManager().findFragmentById(R.id.photoPagerFragment);
        }
        pagerFragment.setPhotos(paths, thumbnails, currentItem);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (showDelete) {
            getMenuInflater().inflate(R.menu.photo_picker_menu_preview, menu);
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.delete) {
            ...
            Snackbar snackbar = Snackbar.make(pagerFragment.getView(), R.string.photo_picker_deleted_a_photo,
            ...
            if (pagerFragment.getPaths().size() <= 1) {
                ...
                new AlertDialog.Builder(this)
                        .setMessage(R.string.photo_picker_confirm_to_delete)
                        .setPositiveButton(R.string.photo_picker_yes, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dialogInterface.dismiss();
                                if (pagerFragment.getPaths() != null) {
            ...
            snackbar.setAction(R.string.photo_picker_undo, new View.OnClickListener() {
                @Override
    ...
    public void updateActionBarTitle() {
        if (actionBar != null) actionBar.setTitle(
                getString(R.string.photo_picker_image_index, pagerFragment.getViewPager().getCurrentItem() + 1,
