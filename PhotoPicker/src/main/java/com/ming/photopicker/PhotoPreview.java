...
public class PhotoPreview {
    ...
    public final static String EXTRA_THUMBNAILS = "thumbnails";
    ...
    public static class PhotoPreviewBuilder {
        ...
        public PhotoPreviewBuilder setThumbnails(ArrayList<String> thumbnails) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_THUMBNAILS, thumbnails);
            return this;
        }
    }
}
