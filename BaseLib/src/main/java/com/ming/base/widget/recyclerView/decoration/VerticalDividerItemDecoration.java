...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    @Override
    protected void setDividerStartBound(Rect outRect, int position, RecyclerView parent) {
        int top = parent.getPaddingTop();
        if (top != outRect.top) {
            outRect.set(outRect.left, top, outRect.right, outRect.top);
        }
    }

    @Override
    protected void setDividerEndBound(Rect outRect, int position, RecyclerView parent) {
        int bottom = parent.getHeight() - parent.getPaddingBottom();
        if (bottom != outRect.bottom) {
            outRect.set(outRect.left, outRect.bottom, outRect.right, bottom);
        }
    }
