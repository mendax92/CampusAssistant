...
public class MaterialDialog extends DialogBase implements
    ...
    public final void setProgressComplete(@DrawableRes int drawable) {
        Drawable d = ContextCompat.getDrawable(mBuilder.context, drawable);
        if (d != null) {
            setProgressComplete(d);
        }
    }

    public final void setProgressComplete(Drawable drawable) {
        if (mComplete != null) {
            if (mProgress != null) {
                mProgress.setVisibility(View.GONE);
            }
            mComplete.setVisibility(View.VISIBLE);
            mComplete.setImageDrawable(drawable);
        }
    }
    ...
    protected void setInternalInputCallback() {
        ...
        input.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                final int length = DialogUtils.getValidText(input).length();
