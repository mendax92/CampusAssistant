...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        if (builder.customView != null) {
            ...
            if (builder.wrapCustomViewInScroll) {
                ...
                int paddingTop = r.getDimensionPixelSize(R.dimen.md_content_padding_top) + (builder.title != null ? 0 : framePadding);
    ...
    private static void setupProgressDialog(final MaterialDialog dialog) {
        ...
        if (builder.indeterminateProgress || builder.progress > -2) {
            ...
            dialog.mComplete = (ImageView) dialog.view.findViewById(R.id.md_complete);
